...
"varying vec2 v_blur_tex_coords[11];\n"
...
"	gl_FragColor += texture2D(u_tex, v_blur_tex_coords[0]) * 0.0093;\n"
"	gl_FragColor += texture2D(u_tex, v_blur_tex_coords[1]) * 0.028002;\n"
"	gl_FragColor += texture2D(u_tex, v_blur_tex_coords[2]) * 0.065984;\n"
"	gl_FragColor += texture2D(u_tex, v_blur_tex_coords[3]) * 0.121703;\n"
"	gl_FragColor += texture2D(u_tex, v_blur_tex_coords[4]) * 0.175713;\n"
"	gl_FragColor += texture2D(u_tex, v_blur_tex_coords[5]) * 0.198596;\n"
"	gl_FragColor += texture2D(u_tex, v_blur_tex_coords[6]) * 0.175713;\n"
"	gl_FragColor += texture2D(u_tex, v_blur_tex_coords[7]) * 0.121703;\n"
"	gl_FragColor += texture2D(u_tex, v_blur_tex_coords[8]) * 0.065984;\n"
"	gl_FragColor += texture2D(u_tex, v_blur_tex_coords[9]) * 0.028002;\n"
"	gl_FragColor += texture2D(u_tex, v_blur_tex_coords[10]) * 0.0093;\n"
"}\n";
