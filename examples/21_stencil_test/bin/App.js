...
var ASM_CONSTS = {
 ...
 12671: function($0) {return miniaudio.get_device_by_index($0).webaudio.sampleRate;},  
 12773: function($0) {var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; if (device.intermediaryBuffer !== undefined) { Module._free(device.intermediaryBuffer); device.intermediaryBuffer = undefined; device.intermediaryBufferView = undefined; device.intermediaryBufferSizeInBytes = undefined; } miniaudio.untrack_device_by_index($0);},  
 13452: function($0) {miniaudio.get_device_by_index($0).webaudio.resume();},  
 13534: function($0) {miniaudio.get_device_by_index($0).webaudio.suspend();}
};
