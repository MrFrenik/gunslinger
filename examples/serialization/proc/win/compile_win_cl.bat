...
rem Name
set name=Serialization

rem Include directories 
set inc=/I ..\..\..\include /I ..\include\ /I ..\source\ /I ..\..\..\third_party\include\

rem Source files
set src_main=..\source\*.c ..\source\font\*.c
...
shell32.lib vcruntime.lib msvcrt.lib gdi32.lib Comdlg32.lib Ole32.lib Advapi32.lib 
